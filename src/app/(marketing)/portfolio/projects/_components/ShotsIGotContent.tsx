      ...
      <ScreenshotPanel image={"/screenshots/shots-igot-sample-usage.png"}>
        <BodyText>
          <BodyParagraph>
            ...
            this concept to the Princeton Hackathon, built the initial prototype in 48 hours and won the Crowd-Favorite
            Project award.
          </BodyParagraph>
          <BodyParagraph>
      ...
      <ScreenshotPanel image={"/screenshots/shots-igot-news.jpg"} reverse darkBg>
        ...
        <BodyText>
          <BodyParagraph>
            ...
            marketing, so we created fliers in Photoshop and printed as many as we could at the library and slipped them
            under hundreds of dorm room doors.
          </BodyParagraph>
          <BodyParagraph>
          ...
          <BodyParagraph>
            Eventually, the excitement around Shots iGot took on a life of its own, with users coming from schools all
            over the country. In just a few months, we gained nearly ten thousand users and were featured in various
