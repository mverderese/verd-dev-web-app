          ...
          <BodyParagraph>
            <UL>
              ...
              <LI title={"Hosting in Demandware"}>
                Created an automated service that would pre-render every page of the React application to static HTML
                and upload it to custom pages in Demandware via the Admin API. This allowed us to leverage the existing
              ...
              <LI title={"Team Coordination"}>
                The site was designed to showcase hundreds of coffee, tea, drinkware, and gift products, including
                specialty bundles and collections. This required ongoing coordination between our team and various
                stakeholders across the Starbucks organization to ensure a seamless launch.
              </LI>
            </UL>
          </BodyParagraph>
          <BodyParagraph>
