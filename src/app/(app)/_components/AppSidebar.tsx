...
export default function AppSidebar() {
  return (
    <>
      ...
      >
        <div className="px-6">
          <a className="flex-none text-xl font-semibold dark:text-white" href="/app" aria-label="Brand">
            {APP_TITLE}
          </a>
        </div>
        ...
        <nav className="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open={false}>
          <ul className="space-y-1.5">
            <li>
              <a
                className="flex items-center gap-x-3.5 py-2 px-2.5 bg-gray-100 text-sm text-slate-700 rounded-lg hover:bg-gray-100 dark:bg-gray-900 dark:text-white"
                href="#"
              >
                <svg
                  className="flex-shrink-0 size-4"
            ...
            <li className="hs-accordion" id="users-accordion">
              ...
              >
                <ul className="hs-accordion-group ps-3 pt-2" data-hs-accordion-always-open={false}>
                  <li className="hs-accordion" id="users-accordion-sub-1">
                    ...
                    >
                      <ul className="pt-2 ps-2">
                        <li>
                          <a
                            className="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-lg hover:bg-gray-100 dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300"
                            href="#"
                          >
                            Link 1
                          </a>
            ...
            <li>
              <a
                className="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300"
                href="#"
              >
                <svg
                  className="flex-shrink-0 size-4"
